...
files = ["wave_0_1998_data.tab", "wave_0_1999_data.tab", "wave_0_2001_data.tab", 
        ...
        "wave_5_elsa_data_v4.tab",   
         "wave_6_elsa_data_v2.tab", "wave_6_elsa_nurse_data_v2.tab","wave_7_elsa_data.tab", 
         "wave_8_elsa_data_eul_v2.tab", "wave_8_elsa_nurse_data_eul_v1.tab"]
...
# end of life data
eol2 = pd.read_csv(folder+"elsa_eol_w2_archive_v1.sav", usecols=['idauniq','EiDateY'],delimiter='\t')
eol2['idauniq'] = eol2['idauniq'].astype(int)
eol2 = eol2.set_index('idauniq')

eol3 = pd.read_csv(folder+"elsa_eol_w3_archive_v1.sav",usecols=['idauniq','EiDateY'],delimiter='\t')
eol3['idauniq'] = eol3['idauniq'].astype(int)
eol3 = eol3.set_index('idauniq')

eol4 = pd.read_csv(folder+"elsa_eol_w4_archive_v1.sav",usecols=['idauniq','EiDateY'],delimiter='\t')
eol4['idauniq'] = eol4['idauniq'].astype(int)
eol4 = eol4.set_index('idauniq')

eol6 = pd.read_csv(folder+"elsa_endoflife_w6archive.sav",usecols=['idauniq','EiDateY'],delimiter='\t')
...
print(getDuplicateColumns(combined_waves['wave0']))
