...
variables = ['longill', 'limitact', 'effort', 'smkevr', 'smknow', 'height', 'bmi', 'mobility', 'country',
              'alcohol', 'jointrep', 'fractures', 'ethnicity', 'gait speed', 'grip dom', 'grip ndom', 
